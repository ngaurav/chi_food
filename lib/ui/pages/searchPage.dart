...
class _CustomSearchPageState extends State<CustomSearchPage>
  ...
  List<String> hintList = [
    ...
    'Search by location to find review',
    'Search username'
  ];
  String entity_id;
  String entity_type;
  ...
  void performSearch(String query) async {
    ...
    if (default_int == 0) {
      repos =
          await searchRestaurants(widget.client, query, entity_id, entity_type);
    } else {
      reviewrepo = await searchYelpBusiness(widget.yelpClient,
          term: query, latitude: lat, longitude: long);
    }
        ...
        body: SafeArea(
          ...
          child: Stack(
            children: <Widget>[
                        ...
                        Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                suffixIcon: _searchQuery.text.length > 0
                                    ? IconButton(
                                ...
                                fillColor: node.hasFocus
                                    ? Colors.white
                                    : Color(0xffd3d3d3).withOpacity(0.4),
              ...
              !_isSearching && _searchQuery.text.length != 0
                  ? Positioned(
                      top: 70,
                      left: 0,
                      right: 0,
                ...
                return GestureDetector(
                  onTap: () {
                    BlocProvider.of<RestaurantBloc>(context)
                        .add(LoadRestaurantAllInfoEvent(res));
                    BlocProvider.of<MenuBloc>(context).add(LoadMenuEvent());
                    Navigator.pushNamed(context, '/Restaurant',
                        arguments: RestaurantArg(index, res));
                  },
                  child: Container(
                    padding:
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Text(res.user_rating.votes.toString())
                              ],
                            ),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.start,
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: <Widget>[
                              StarRating(
                                rating:
                                    double.parse(curBusiness.rating.toString()),
                              ),
                              SizedBox(
                                width: 5,
                              ),
                          ...
                          Row(
                            ...
                            children: <Widget>[
                              ...
                              ConstrainedBox(
                                constraints: BoxConstraints(maxWidth: 230),
                                child: Text(
                                  curBusiness.location.address1 +
                                      ', ' +
                                      curBusiness.location.city,
                                  overflow: TextOverflow.ellipsis,
                                ),
                              ),
                            ],
